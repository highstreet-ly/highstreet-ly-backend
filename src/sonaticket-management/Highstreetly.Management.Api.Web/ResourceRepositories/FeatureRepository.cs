...
{
    public class FeatureRepository : EntityFrameworkCoreRepository<Feature, Guid>
    {
        ...
        public override Task UpdateAsync(Feature resourceFromRequest, Feature resourceFromDatabase, CancellationToken cancellationToken)
        {
        ...
        public override Task CreateAsync(Feature resourceFromRequest, Feature resourceForDatabase, CancellationToken cancellationToken)
        {
            if (_httpContextAccessor
                .HttpContext == null)
            {

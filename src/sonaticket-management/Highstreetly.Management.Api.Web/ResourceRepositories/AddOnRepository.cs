...
namespace Highstreetly.Management.Api.Web.ResourceRepositories
{
    public class AddOnRepository : EntityFrameworkCoreRepository<AddOn, Guid>
    {
        ...
        public override Task CreateAsync(AddOn resourceFromRequest, AddOn resourceForDatabase, CancellationToken cancellationToken)
        {
            if (_httpContextAccessor
                .HttpContext == null)
            {

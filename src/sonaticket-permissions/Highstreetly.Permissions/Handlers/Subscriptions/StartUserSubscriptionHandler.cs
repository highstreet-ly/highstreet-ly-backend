...
namespace Highstreetly.Permissions.Handlers.Subscriptions
{
    public class StartUserSubscriptionHandler : IConsumer<IStartUserSubscription>
    {
        ...
        public StartUserSubscriptionHandler(
            ILogger<StartUserSubscriptionHandler> logger,
        ...
        public async Task Consume(
            ConsumeContext<IStartUserSubscription> context)
        {
            using (_logger.BeginScope(new Dictionary<string, object> { ["CorrelationId"] = context.CorrelationId, ["SourceId"] = context.Message.Id }))
            {
                ...
                var incomingCustomer = context.Message.SubscriptionStart.Content.Customer;
                ...
                var incomingAddons = context.Message.SubscriptionStart.Content.Subscription.Addons;

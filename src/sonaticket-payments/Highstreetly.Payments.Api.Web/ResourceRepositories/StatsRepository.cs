...
namespace Highstreetly.Payments.Api.Web.ResourceRepositories
{
    public class StatsRepository : EntityFrameworkCoreRepository<Stats, Guid>
    {
        ...
        protected override IQueryable<Stats> GetAll()
        {
            if (_httpContextAccessor
                .HttpContext == null)
            {

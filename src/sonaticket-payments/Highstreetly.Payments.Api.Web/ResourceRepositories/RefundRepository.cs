...
{
    public class RefundRepository : EntityFrameworkCoreRepository<Refund, Guid>
    {
        ...
        public override async Task<int> CountAsync(FilterExpression topFilter, CancellationToken cancellationToken)
        {
            ...
            return await base.GetAll()
                             ...
                             .Where(x => eventInstanceIds.Contains(x.Charge.Payment.EventInstanceId))
                             .CountAsync(cancellationToken: cancellationToken);
        }
        
        protected override IQueryable<Refund> GetAll()
        {
            if (_httpContextAccessor
                .HttpContext == null)
            {

...
{
    public class ApplicationFeeRefundedHandler : IConsumer<IApplicationFeeRefunded>
    {
        private readonly ILogger<ApplicationFeeRefundedHandler> _logger;
        private readonly IAzureStorage _azureStorage;

        public ApplicationFeeRefundedHandler(
            ILogger<ApplicationFeeRefundedHandler> logger,
        ...
        public async Task Consume(
            ConsumeContext<IApplicationFeeRefunded> context)
        {

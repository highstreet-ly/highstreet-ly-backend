...
{
    public class SetOrderProcessingCompleteHandler : IConsumer<ISetOrderProcessingComplete>
    {
        private readonly ILogger<SetOrderProcessingCompleteHandler> _logger;
        private readonly IEventSourcedRepository<Order> _repository;

        public SetOrderProcessingCompleteHandler(
            ILogger<SetOrderProcessingCompleteHandler> logger,
        ...
        public async Task Consume(
            ConsumeContext<ISetOrderProcessingComplete> command)
        {
